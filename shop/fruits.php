...
<title>GreenBasket — Fruits</title>
...
<div class="shop-hero">
  ...
  <h1 class="shop-hero-title">Today's <em>Fruits</em></h1>
  <div class="shop-search-wrap">
    <span class="shop-search-icon"><i class="fas fa-search"></i></span>
    <input type="text" id="productSearch" placeholder="Search fruits by name…" class="search-input">
  </div>
</div>
  ...
  <main class="product-listing">
    <?php if ($result->num_rows === 0): ?>
      <div class="empty-state">
        ...
        <p>No fruit products available right now.</p>
      </div>
    <?php else: ?>
